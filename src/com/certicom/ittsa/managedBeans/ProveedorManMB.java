...
@ManagedBean(name="proveedorManMB")
@ViewScoped
public class ProveedorManMB extends GenericBeans implements Serializable{
	...
	public void incia()
	{
		...
		//listando
		try {
			this.listaProveedores = proveedorSevice.listarProveedorMAN();
	...
	public void eliminarProveedor()
	{
		try {
			RequestContext context = RequestContext.getCurrentInstance();
			int cant = 0;
			cant = this.proveedorSevice.cantProveedoresxAutoparte((proveedor.getIdProveedor()));
			if(cant == 0){
