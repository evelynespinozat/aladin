...
@ManagedBean(name="servicioCorrectivoMB")
@ViewScoped
public class ServicioCorrectivoMB extends GenericBeans implements Serializable{
	...
	public void incia()
	{
		...
		//listando
		try {
			this.listaBusesCambio = this.flotaService.busesxCambioAll();
	...
	public String asignarMecanico(Flota flota){
		...
		try {
    		...
    		outcome="pretty:mantAutoparteCorrectivo";
		} catch (Exception e) {	
			e.printStackTrace();
		}
		return outcome;
